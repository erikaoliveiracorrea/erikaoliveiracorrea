...
💻📚Estou em constante aprendizado, explorando diversas áreas como HTML, CSS, JavaScript, Node.js, Mysql, MongoDB.
 Conquistei a certificação AWS Cloud Practitioner, ampliando meus conhecimentos em computação em nuvem e infraestrutura       escalável. 🎓Sou estudante de Análise e Desenvolvimento de Sistemas, com foco em desenvolvimento de sistema.
 Atualmente, estou estudando Java e Spring Boot, desenvolvendo conhecimentos em programação orientada a objetos,              desenvolvimento de APIs e integração com banco de dados(Mysql e PostegreSql).
 #
...
<img align="center" alt="MongoDB" height="40" width="40" src="https://img.icons8.com/?size=100&id=74402&format=png&color=000000"> 
